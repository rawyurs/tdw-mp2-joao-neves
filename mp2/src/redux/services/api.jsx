...
export const api = createApi({
    reducerPath: 'api',
    baseQuery: fetchBaseQuery({ baseUrl: 'https://stranger-things-api.fly.dev/api/v1/' }),
    endpoints: (builder) => ({
...
export const { useGetCharactersQuery, useGetCharacterByIdQuery, useGetCharactersByEpisodeQuery } = api;
